...
public class EntityGiantSkeleton extends EntityMob implements IRangedAttackMob, IBossDisplayData {
	...
	public void onDeath(DamageSource d) {
		...
		DovakiinAPI.addChatMessage(EnumChatFormatting.DARK_BLUE, Minecraft.getMinecraft().thePlayer.getDisplayName() + "Has killed the Giant Skeleton and gained " + levels + "levels");
	}
