...
public class ModelWitherSkeleton extends ModelZombie
{
    private static final String __OBFID = "CL_00000857";

    public ModelWitherSkeleton()
    {
        this(0.0F);
    }

    public ModelWitherSkeleton(float par1)
    {
    ...
    {
        this.aimedBow = ((EntityWitherSkeleton)par1EntityLivingBase) != null;
